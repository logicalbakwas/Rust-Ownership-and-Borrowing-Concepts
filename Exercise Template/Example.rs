...
fn main() {
    ...
    // TODO: Create a function that takes ownership of a String and prints it
    // TODO: Call the function with 'name'
    // TODO: Try to use 'name' again after the function call and observe the error
}
